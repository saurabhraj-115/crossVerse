  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8">
      ...
      <div className="mb-8 text-center">
        ...
        <h1 className="text-3xl font-bold text-gray-900">Scripture Comparison</h1>
      ...
      <div className="mb-8 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <div className="mb-5">
          ...
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 rounded-lg border border-gray-300 px-3 py-2.5 text-sm focus:border-indigo-400 focus:outline-none focus:ring-1 focus:ring-indigo-400"
            />
            <button
          ...
          <div className="mt-3 flex flex-wrap gap-1.5">
            {QUICK_TOPICS.map((t) => (
              <button
                ...
                className="rounded-full border border-gray-200 bg-gray-50 px-2.5 py-1 text-xs text-gray-600 hover:border-indigo-300 hover:text-indigo-600 transition-colors"
              >
                {t}
              </button>
            ))}
        ...
        <div>
          <label className="mb-1.5 block text-sm font-semibold text-gray-700">
            ...
            <span className="font-normal text-gray-400">(select 2–6)</span>
          </label>
          ...
          {selectedReligions.length < 2 && (
            <p className="mt-2 text-xs text-red-500">Select at least 2 religions to compare.</p>
          )}
        </div>
      </div>
              ...
              return (
                ...
                >
                  <div className="mb-4 flex items-center gap-2">
                    ...
                    <h3 className="font-bold text-gray-900 text-lg">{religion}</h3>
                    <span className="ml-auto rounded-full px-2 py-0.5 text-xs font-bold text-white" style={{ backgroundColor: color }}>
                      {verses.length} verses
                    </span>
                  </div>
                  {verses.length === 0 ? (
                    <p className="text-sm text-gray-400 italic">No relevant passages found.</p>
                  ) : (
