"""
Ingest Early Church Fathers texts from Project Gutenberg (Public Domain):
  - First Epistle of Clement  (PG #24)
  - Epistles of Ignatius       (PG #18542)
  - Justin Martyr – First Apology (PG #9298)
...
TEXTS = [
    {
        "url":         "https://www.gutenberg.org/cache/epub/24/pg24.txt",
        "name":        "First Epistle of Clement",
        "id_prefix":   "Clement1",
        "translation": "First Epistle of Clement (Public Domain)",
        "book":        "First Epistle of Clement",
    },
    {
        "url":         "https://www.gutenberg.org/cache/epub/18542/pg18542.txt",
        "name":        "Epistles of Ignatius",
        "id_prefix":   "Ignatius",
        "translation": "Epistles of Ignatius of Antioch (Public Domain)",
        "book":        "Epistles of Ignatius",
    },
    {
        "url":         "https://www.gutenberg.org/cache/epub/9298/pg9298.txt",
        "name":        "Justin Martyr – First Apology",
        "id_prefix":   "JustinMartyr",
        "translation": "First Apology of Justin Martyr (Public Domain)",
        "book":        "First Apology of Justin Martyr",
    },
]
...
async def ingest_church_fathers():
                ...
                points = [
                    PointStruct(
                        id=str(uuid.uuid5(uuid.NAMESPACE_DNS,
                               f"Christianity:Fathers:{cfg['id_prefix']}:{v['verse']}")),
                        vector=emb,
                        payload=v,
                    )
    ...
    logger.info("Church Fathers ingestion complete. Grand total: %d", grand_total)


if __name__ == "__main__":
    asyncio.run(ingest_church_fathers())
